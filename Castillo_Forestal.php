...
<body>
    ...
    <div class="container">
        ...
        <table class="reservation-table">
            <tr>
                <td class="image-cell">
                    ...
                    <img src="Castillo_Forestal.jfif" alt="Castillo Forestal" class="image">
                </td>
                <td class="info-cell">
                    <h2>Descripción</h2>
                    <p class="intro-text">
                        Castillo Forestal es un hermoso restaurante ubicado en un entorno natural, conocido por su ambiente acogedor y su deliciosa comida. Es ideal para disfrutar de una experiencia gastronómica única rodeado de naturaleza.
                    </p>
        ...
        <div class="comments-container">
            ...
            <div class="star-image">
                ...
                <form id="comentarioForm" onsubmit="submitComment(event, 'comentariosCastilloForestal')">
                    ...
                    <button type="button" onclick="clearComments('comentariosCastilloForestal')">Borrar Comentarios</button>
                </form>
            </div>
    ...
    <script>
       ...
       document.addEventListener("DOMContentLoaded", function() {
           displayComments('comentariosCastilloForestal');
       });
    </script>
</body>
</html>
