...
<body>
    ...
    <div class="container">
        ...
        <table class="reservation-table">
            <tr>
                <td class="image-cell">
                    ...
                    <img src="Guy_Savoy.jfif" alt="Guy Savoy" class="image">
                </td>
                <td class="info-cell">
                    <h2>Descripción</h2>
                    <p class="intro-text">
                        Guy Savoy es un destino culinario que ofrece una experiencia gastronómica excepcional con una cocina que combina la tradición francesa con un enfoque moderno. Con un ambiente elegante y un servicio impecable, es ideal para quienes buscan lo mejor en la alta cocina.
                    </p>
        ...
        <div class="comments-container">
            ...
            <div class="star-image">
                ...
                <form id="comentarioForm" onsubmit="submitComment(event, 'comentariosGuySavoy')">
                    ...
                    <button type="button" onclick="clearComments('comentariosGuySavoy')">Borrar Comentarios</button>
                </form>
            </div>
    ...
    <script>
       ...
       document.addEventListener("DOMContentLoaded", function() {
           displayComments('comentariosGuySavoy');
       });
    </script>
</body>
</html>
