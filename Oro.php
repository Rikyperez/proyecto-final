...
<body>
    ...
    <div class="container">
        ...
        <table class="reservation-table">
            <tr>
                <td class="image-cell">
                    ...
                    <img src="Oro.jfif" alt="Oro" class="image">
                </td>
                <td class="info-cell">
                    <h2>Descripción</h2>
                    <p class="intro-text">
                        Oro es un restaurante que ofrece una experiencia gastronómica única, combinando sabores locales con técnicas culinarias modernas. Disfruta de una variedad de platos innovadores en un ambiente elegante y acogedor.
                    </p>
        ...
        <div class="comments-container">
            ...
            <div class="star-image">
                ...
                <form id="comentarioForm" onsubmit="submitComment(event, 'comentariosOro')">
                    ...
                    <button type="button" onclick="clearComments('comentariosOro')">Borrar Comentarios</button>
                </form>
            </div>
    ...
    <script>
       ...
       document.addEventListener("DOMContentLoaded", function() {
           displayComments('comentariosOro');
       });
    </script>
</body>
</html>
