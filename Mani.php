...
<body>
    ...
    <div class="container">
        ...
        <table class="reservation-table">
            <tr>
                <td class="image-cell">
                    ...
                    <img src="Mani.jfif" alt="Mani" class="image">
                </td>
                <td class="info-cell">
                    <h2>Descripción</h2>
                    <p class="intro-text">
                        Mani es un restaurante que combina sabores tradicionales con un enfoque moderno, ofreciendo platos deliciosos y creativos en un ambiente acogedor. Perfecto para disfrutar con amigos y familiares.
                    </p>
        ...
        <div class="comments-container">
            ...
            <div class="star-image">
                ...
                <form id="comentarioForm" onsubmit="submitComment(event, 'comentariosMani')">
                    ...
                    <button type="button" onclick="clearComments('comentariosMani')">Borrar Comentarios</button>
                </form>
            </div>
    ...
    <script>
       ...
       document.addEventListener("DOMContentLoaded", function() {
           displayComments('comentariosMani');
       });
    </script>
</body>
</html>
