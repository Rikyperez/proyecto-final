...
<body>
    ...
    <div class="container">
        ...
        <table class="reservation-table">
            <tr>
                <td class="image-cell">
                    ...
                    <img src="El_Zocalo.jfif" alt="El Zócalo" class="image">
                </td>
                <td class="info-cell">
                    <h2>Descripción</h2>
                    <p class="intro-text">
                        El Zócalo es un restaurante emblemático que ofrece una experiencia gastronómica auténtica, con una fusión de sabores tradicionales y contemporáneos que te transportarán a México.
                    </p>
        ...
        <div class="comments-container">
            ...
            <div class="star-image">
                ...
                <form id="comentarioForm" onsubmit="submitComment(event, 'comentariosElZocalo')">
                    ...
                    <button type="button" onclick="clearComments('comentariosElZocalo')">Borrar Comentarios</button>
                </form>
            </div>
    ...
    <script>
       ...
       document.addEventListener("DOMContentLoaded", function() {
           displayComments('comentariosElZocalo');
       });
    </script>
</body>
</html>
