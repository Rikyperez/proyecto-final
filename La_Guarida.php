...
<body>
    ...
    <div class="container">
        ...
        <table class="reservation-table">
            <tr>
                <td class="image-cell">
                    ...
                    <img src="La_Guarida.jfif" alt="La Guarida" class="image">
                </td>
                <td class="info-cell">
                    <h2>Descripción</h2>
                    <p class="intro-text">
                        La Guarida es un restaurante acogedor que ofrece una variedad de platillos tradicionales con un toque moderno. Su ambiente íntimo y su atención al detalle hacen que cada comida sea una celebración.
                    </p>
        ...
        <div class="comments-container">
            ...
            <div class="star-image">
                ...
                <form id="comentarioForm" onsubmit="submitComment(event, 'comentariosLaGuarida')">
                    ...
                    <button type="button" onclick="clearComments('comentariosLaGuarida')">Borrar Comentarios</button>
                </form>
            </div>
    ...
    <script>
       ...
       document.addEventListener("DOMContentLoaded", function() {
           displayComments('comentariosLaGuarida');
       });
    </script>
</body>
</html>
