...
<body>
    ...
    <div class="container">
        ...
        <table class="reservation-table">
            <tr>
                <td class="image-cell">
                    ...
                    <img src="Sequoia.jfif" alt="sequoia" class="image">
                </td>
                <td class="info-cell">
                    <h2>Descripción</h2>
                    <p class="intro-text">
                        sequoia es un distinguido restaurante conocido por su enfoque sostenible y su fusión de sabores únicos de la cocina moderna. Ofrece una experiencia innovadora y elegante que refleja un compromiso profundo con el entorno y la calidad.
                    </p>
        ...
        <div class="comments-container">
            ...
            <div class="star-image">
                ...
                <form id="comentarioForm" onsubmit="submitComment(event, 'comentariossequoia')">
                    ...
                    <button type="button" onclick="clearComments('comentariossequoia')">Borrar Comentarios</button>
                </form>
            </div>
    ...
    <script>
       ...
       document.addEventListener("DOMContentLoaded", function() {
           displayComments('comentariossequoia');
       });
    </script>
</body>
</html>
