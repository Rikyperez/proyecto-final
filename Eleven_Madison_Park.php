...
<body>
    ...
    <div class="container">
        ...
        <table class="reservation-table">
            <tr>
                <td class="image-cell">
                    ...
                    <img src="Eleven_Madison_Park.jfif" alt="Eleven Madison Park" class="image">
                </td>
                <td class="info-cell">
                    <h2>Descripción</h2>
                    <p class="intro-text">
                        Eleven Madison Park es un restaurante de renombre en Nueva York, conocido por su innovadora cocina y su enfoque en ingredientes de origen local.
                    </p>

                    <!-- Botón para ir a formulario1.html -->
        ...
        <div class="comments-container">
            ...
            <div class="star-image">
                ...
                <form id="comentarioForm" onsubmit="submitComment(event, 'comentariosElevenMadisonPark')">
                    ...
                    <button type="button" onclick="clearComments('comentariosElevenMadisonPark')">Borrar Comentarios</button>
                </form>
            </div>
    ...
    <script>
       ...
       document.addEventListener("DOMContentLoaded", function() {
           displayComments('comentariosElevenMadisonPark');
       });
    </script>
</body>
</html>
