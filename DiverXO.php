...
<body>
    ...
    <div class="container">
        ...
        <table class="reservation-table">
            <tr>
                <td class="image-cell">
                    ...
                    <img src="DiverXO.jfif" alt="DiverXO" class="image">
                </td>
                <td class="info-cell">
                    <h2>Descripción</h2>
                    <p class="intro-text">
                        DiverXO es una experiencia gastronómica única, donde la creatividad y la innovación se encuentran en cada plato, ofreciendo un viaje culinario sin igual.
                    </p>
        ...
        <div class="comments-container">
            ...
            <div class="star-image">
                ...
                <form id="comentarioForm" onsubmit="submitComment(event, 'comentariosDiverXO')">
                    ...
                    <button type="button" onclick="clearComments('comentariosDiverXO')">Borrar Comentarios</button>
                </form>
            </div>
    ...
    <script>
       ...
       document.addEventListener("DOMContentLoaded", function() {
           displayComments('comentariosDiverXO');
       });
    </script>
</body>
</html>
