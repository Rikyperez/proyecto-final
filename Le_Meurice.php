...
function submitComment(event, storageKey) {
    ...
    if (nombre && comentario) {
        ...
        // Limpiar el campo de comentario y restablecer las estrellas
...
// Función para reiniciar las estrellas visualmente
function resetStars() {
    currentRating = 0; // Restablecer la calificación a 0
    const stars = document.querySelectorAll('.star-image img'); // Obtener todas las imágenes de estrellas
    
    // Mostrar todas las estrellas vacías
    stars.forEach((star) => {
        star.src = 'estrella2.png'; // Mostrar estrella vacía
    });
}
