...
<body>
    ...
    <div class="container">
        ...
        <table class="reservation-table">
            <tr>
                <td class="image-cell">
                    <!-- Imagen del jfif -->
                    <img src="Fogo_de_Chao.jfif" alt="Fogo de Chão" class="image">
                </td>
                <td class="info-cell">
                    <h2>Descripción</h2>
                    <p class="intro-text">
                        Fogo de Chão es un restaurante brasileño de parrilla conocido por su auténtica experiencia de churrasco. Con una amplia variedad de carnes asadas y un delicioso buffet de ensaladas, es el lugar perfecto para los amantes de la carne.
                    </p>
        ...
        <div class="comments-container">
            ...
            <div class="star-image">
                ...
                <form id="comentarioForm" onsubmit="submitComment(event, 'comentariosFogoDeChao')">
                    ...
                    <button type="button" onclick="clearComments('comentariosFogoDeChao')">Borrar Comentarios</button>
                </form>
            </div>
    ...
    <script>
       ...
       document.addEventListener("DOMContentLoaded", function() {
           displayComments('comentariosFogoDeChao');
       });
    </script>
</body>
</html>
