...
<body>
    ...
    <div class="container">
        ...
        <table class="reservation-table">
            <tr>
                <td class="image-cell">
                    ...
                    <img src="Borago.jfif" alt="Borago" class="image">
                </td>
                <td class="info-cell">
                    <h2>Descripción</h2>
                    <p class="intro-text">
                        Borago ofrece una experiencia culinaria única que resalta los sabores autóctonos de Chile. Con un enfoque en ingredientes frescos y de temporada, cada plato es una celebración de la biodiversidad local y la innovación gastronómica.
                    </p>
        ...
        <div class="comments-container">
            ...
            <div class="star-image">
                ...
                <form id="comentarioForm" onsubmit="submitComment(event, 'comentariosBorago')">
                    ...
                    <button type="button" onclick="clearComments('comentariosBorago')">Borrar Comentarios</button>
                </form>
            </div>
    ...
    <script>
       ...
       document.addEventListener("DOMContentLoaded", function() {
           displayComments('comentariosBorago');
       });
    </script>
</body>
</html>
