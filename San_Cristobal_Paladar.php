...
<head>
    ...
    <title>San Cristóbal Paladar</title>
...
<body>
    ...
    <div class="container">
        ...
        <table class="reservation-table">
            <tr>
                <td class="image-cell">
                    ...
                    <img src="San_Cristobal_Paladar.jfif" alt="San Cristóbal Paladar" class="image">
                </td>
                <td class="info-cell">
                    <h2>Descripción</h2>
                    <p class="intro-text">
                        San Cristóbal Paladar es un icónico restaurante cubano conocido por su cocina auténtica y su atmósfera única. Ubicado en La Habana, ofrece una experiencia gastronómica que combina historia, cultura y sabores tradicionales cubanos en cada plato.
                    </p>
        ...
        <div class="comments-container">
            ...
            <div class="star-image">
                ...
                <form id="comentarioForm" onsubmit="submitComment(event, 'comentariosSanCristobalPaladar')">
                    ...
                    <button type="button" onclick="clearComments('comentariosSanCristobalPaladar')">Borrar Comentarios</button>
                </form>
            </div>
    ...
    <script>
       ...
       document.addEventListener("DOMContentLoaded", function() {
           displayComments('comentariosSanCristobalPaladar');
       });
    </script>
</body>
</html>
