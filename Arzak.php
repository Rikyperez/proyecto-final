...
<body>
    ...
    <div class="container">
        ...
        <table class="reservation-table">
            <tr>
                <td class="image-cell">
                    ...
                    <img src="Arzak.jfif" alt="Arzak" class="image">
                </td>
                <td class="info-cell">
                    <h2>Descripción</h2>
                    <p class="intro-text">
                        Arzak es un icónico restaurante en San Sebastián, famoso por su innovadora cocina vasca que combina tradición y modernidad, ofreciendo una experiencia gastronómica única y memorable.
                    </p>
        ...
        <div class="comments-container">
            ...
            <div class="star-image">
                ...
                <form id="comentarioForm" onsubmit="submitComment(event, 'comentariosArzak')">
                    ...
                    <button type="button" onclick="clearComments('comentariosArzak')">Borrar Comentarios</button>
                </form>
            </div>
    ...
    <script>
       ...
       document.addEventListener("DOMContentLoaded", function() {
           displayComments('comentariosArzak');
       });
    </script>
</body>
</html>
