...
<body>
    ...
    <div class="container">
        ...
        <table class="reservation-table">
            <tr>
                <td class="image-cell">
                    ...
                    <img src="El_Bodegon.jfif" alt="El Bodegón" class="image">
                </td>
                <td class="info-cell">
                    <h2>Descripción</h2>
                    <p class="intro-text">
                        El Bodegón ofrece una experiencia gastronómica auténtica, donde la tradición se fusiona con la modernidad para crear platos llenos de sabor y pasión.
                    </p>
        ...
        <div class="comments-container">
            ...
            <div class="star-image">
                ...
                <form id="comentarioForm" onsubmit="submitComment(event, 'comentariosElBodegon')">
                    ...
                    <button type="button" onclick="clearComments('comentariosElBodegon')">Borrar Comentarios</button>
                </form>
            </div>
    ...
    <script>
       ...
       document.addEventListener("DOMContentLoaded", function() {
           displayComments('comentariosElBodegon');
       });
    </script>
</body>
</html>
