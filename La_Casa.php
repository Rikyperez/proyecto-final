...
<body>
    ...
    <div class="container">
        ...
        <table class="reservation-table">
            <tr>
                <td class="image-cell">
                    ...
                    <img src="La_Casa.jfif" alt="La Casa" class="image">
                </td>
                <td class="info-cell">
                    <h2>Descripción</h2>
                    <p class="intro-text">
                        La Casa es un lugar encantador que ofrece una variedad de platillos caseros con ingredientes frescos. Su ambiente cálido y acogedor lo convierte en el lugar perfecto para disfrutar de una comida con amigos y familiares.
                    </p>
        ...
        <div class="comments-container">
            ...
            <div class="star-image">
                ...
                <form id="comentarioForm" onsubmit="submitComment(event, 'comentariosLaCasa')">
                    ...
                    <button type="button" onclick="clearComments('comentariosLaCasa')">Borrar Comentarios</button>
                </form>
            </div>
    ...
    <script>
       ...
       document.addEventListener("DOMContentLoaded", function() {
           displayComments('comentariosLaCasa');
       });
    </script>
</body>
</html>
