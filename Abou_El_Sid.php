...
<body>
    ...
    <div class="container">
        ...
        <table class="reservation-table">
            <tr>
                <td class="image-cell">
                    ...
                    <img src="Abou_El_Sid.jfif" alt="Abou El Sid" class="image">
                </td>
                <td class="info-cell">
                    <h2>Descripción</h2>
                    <p class="intro-text">
                        Abou El Sid es un restaurante emblemático que ofrece una experiencia auténtica de la cocina egipcia, destacando platos tradicionales en un ambiente cálido y acogedor.
                    </p>
        ...
        <div class="comments-container">
            ...
            <div class="star-image">
                ...
                <form id="comentarioForm" onsubmit="submitComment(event, 'comentariosAbouElSid')">
                    ...
                    <button type="button" onclick="clearComments('comentariosAbouElSid')">Borrar Comentarios</button>
                </form>
            </div>
    ...
    <script>
       ...
       document.addEventListener("DOMContentLoaded", function() {
           displayComments('comentariosAbouElSid');
       });
    </script>
</body>
</html>
