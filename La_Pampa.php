...
<body>
    ...
    <div class="container">
        ...
        <table class="reservation-table">
            <tr>
                <td class="image-cell">
                    ...
                    <img src="La_Pampa.jfif" alt="La Pampa" class="image">
                </td>
                <td class="info-cell">
                    <h2>Descripción</h2>
                    <p class="intro-text">
                        La Pampa es un restaurante que ofrece una experiencia culinaria única con un enfoque en la cocina argentina. Conocido por su carne de alta calidad y un ambiente acogedor, es el lugar ideal para disfrutar de una comida inolvidable con amigos y familiares.
                    </p>
        ...
        <div class="comments-container">
            ...
            <div class="star-image">
                ...
                <form id="comentarioForm" onsubmit="submitComment(event, 'comentariosLaPampa')">
                    ...
                    <button type="button" onclick="clearComments('comentariosLaPampa')">Borrar Comentarios</button>
                </form>
            </div>
    ...
    <script>
       ...
       document.addEventListener("DOMContentLoaded", function() {
           displayComments('comentariosLaPampa');
       });
    </script>
</body>
</html>
