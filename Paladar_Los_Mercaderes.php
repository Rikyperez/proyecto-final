...
<head>
    ...
    <title>Paladar Los Mercaderes</title>
...
<body>
    ...
    <div class="container">
        ...
        <table class="reservation-table">
            <tr>
                ...
                <img src="Paladar_Los_Marcaderes.jfif" alt="Paladar Los Mercaderes" class="image">
                </td>
                <td class="info-cell">
                    <h2>Descripción</h2>
                    <p class="intro-text">
                        Paladar Los Mercaderes ofrece una experiencia culinaria auténtica, fusionando sabores tradicionales con un toque contemporáneo. Disfruta de una amplia variedad de platos, elaborados con ingredientes frescos y de calidad, en un ambiente acogedor y amigable.
                    </p>
        ...
        <div class="comments-container">
            ...
            <div class="star-image">
                ...
                <form id="comentarioForm" onsubmit="submitComment(event, 'comentariosLosMercaderes')">
                    ...
                    <button type="button" onclick="clearComments('comentariosLosMercaderes')">Borrar Comentarios</button>
                </form>
            </div>
    ...
    <script>
       ...
       document.addEventListener("DOMContentLoaded", function() {
           displayComments('comentariosLosMercaderes');
       });
    </script>
</body>
</html>
