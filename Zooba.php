...
<body>
    ...
    <div class="container">
        ...
        <table class="reservation-table">
            <tr>
                <td class="image-cell">
                    ...
                    <img src="Zooba.jfif" alt="Zooba" class="image">
                </td>
                <td class="info-cell">
                    <h2>Descripción</h2>
                    <p class="intro-text">
                        Zooba es un restaurante de cocina egipcia moderna, ofreciendo una experiencia única con sabores auténticos y un enfoque en ingredientes frescos.
                    </p>
        ...
        <div class="comments-container">
            ...
            <div class="star-image">
                ...
                <form id="comentarioForm" onsubmit="submitComment(event, 'comentariosZooba')">
                    ...
                    <button type="button" onclick="clearComments('comentariosZooba')">Borrar Comentarios</button>
                </form>
            </div>
    ...
    <script>
       ...
       document.addEventListener("DOMContentLoaded", function() {
           displayComments('comentariosZooba');
       });
    </script>
</body>
</html>
