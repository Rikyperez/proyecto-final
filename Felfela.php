...
<body>
    ...
    <div class="container">
        ...
        <table class="reservation-table">
            <tr>
                <td class="image-cell">
                    ...
                    <img src="Felfela.jfif" alt="Felfela" class="image">
                </td>
                <td class="info-cell">
                    <h2>Descripción</h2>
                    <p class="intro-text">
                        Felfela es conocido por su deliciosa comida egipcia y su ambiente acogedor. Ofrece una variedad de platos tradicionales que te transportarán a Egipto.
                    </p>
        ...
        <div class="comments-container">
            ...
            <div class="star-image">
                ...
                <form id="comentarioForm" onsubmit="submitComment(event, 'comentariosFelfela')">
                    ...
                    <button type="button" onclick="clearComments('comentariosFelfela')">Borrar Comentarios</button>
                </form>
            </div>
    ...
    <script>
       ...
       document.addEventListener("DOMContentLoaded", function() {
           displayComments('comentariosFelfela');
       });
    </script>
</body>
</html>
