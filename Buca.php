...
<body>
    ...
    <div class="container">
        ...
        <table class="reservation-table">
            <tr>
                <td class="image-cell">
                    ...
                    <img src="Buca.jfif" alt="Buca" class="image">
                </td>
                <td class="info-cell">
                    <h2>Descripción</h2>
                    <p class="intro-text">
                        Buca ofrece una experiencia culinaria única, combinando sabores auténticos con un ambiente acogedor. Prueba su famoso menú de pasta y disfruta de una variedad de platos que celebran la cocina italiana.
                    </p>
        ...
        <div class="comments-container">
            ...
            <div class="star-image">
                ...
                <form id="comentarioForm" onsubmit="submitComment(event, 'comentariosBuca')">
                    ...
                    <button type="button" onclick="clearComments('comentariosBuca')">Borrar Comentarios</button>
                </form>
            </div>
    ...
    <script>
       ...
       document.addEventListener("DOMContentLoaded", function() {
           displayComments('comentariosBuca');
       });
    </script>
</body>
</html>
