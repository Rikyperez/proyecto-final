...
<body>
    ...
    <div class="container">
        ...
        <table class="reservation-table">
            <tr>
                <td class="image-cell">
                    ...
                    <img src="El_Pobre_Luis.jfif" alt="El Pobre Luis" class="image">
                </td>
                <td class="info-cell">
                    <h2>Descripción</h2>
                    <p class="intro-text">
                        El Pobre Luis es un lugar acogedor que ofrece una fusión de sabores tradicionales con un toque contemporáneo, ideal para disfrutar de una experiencia gastronómica única.
                    </p>
        ...
        <div class="comments-container">
            ...
            <div class="star-image">
                ...
                <form id="comentarioForm" onsubmit="submitComment(event, 'comentariosElPobreLuis')">
                    ...
                    <button type="button" onclick="clearComments('comentariosElPobreLuis')">Borrar Comentarios</button>
                </form>
            </div>
    ...
    <script>
       ...
       document.addEventListener("DOMContentLoaded", function() {
           displayComments('comentariosElPobreLuis');
       });
    </script>
</body>
</html>
