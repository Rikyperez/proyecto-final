...
<body>
    ...
    <div class="container">
        ...
        <table class="reservation-table">
            <tr>
                <td class="image-cell">
                    ...
                    <img src="Carne_de_Res.jfif" alt="Carne de Res" class="image">
                </td>
                <td class="info-cell">
                    <h2>Descripción</h2>
                    <p class="intro-text">
                        Carne de Res es un lugar ideal para los amantes de la carne. Ofrecemos cortes de res de la más alta calidad, preparados al punto perfecto y acompañados de guarniciones exquisitas. ¡Ven y disfruta de una experiencia culinaria única!
                    </p>
        ...
        <div class="comments-container">
            ...
            <div class="star-image">
                ...
                <form id="comentarioForm" onsubmit="submitComment(event, 'comentariosCarneDeRes')">
                    ...
                    <button type="button" onclick="clearComments('comentariosCarneDeRes')">Borrar Comentarios</button>
                </form>
            </div>
    ...
    <script>
       ...
       document.addEventListener("DOMContentLoaded", function() {
           displayComments('comentariosCarneDeRes');
       });
    </script>
</body>
</html>
