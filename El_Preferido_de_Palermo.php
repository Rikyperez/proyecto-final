        ...
        <table class="reservation-table">
            <tr>
                <td class="image-cell">
                    ...
                    <img src="El_Preferido_de_Palermo.jfif" alt="Palermo" class="image">
                </td>
                <td class="info-cell">
                    <h2>Descripción</h2>
                    <p class="intro-text">
                        Palermo es un destino gastronómico que combina tradición y modernidad, ofreciendo platos inspirados en la cocina argentina con un toque contemporáneo. Su ambiente acogedor y su atención al detalle lo convierten en el lugar ideal para disfrutar de una comida inolvidable.
                    </p>
