...
<body>
    ...
    <div class="container">
        ...
        <table class="reservation-table">
            <tr>
                <td class="image-cell">
                    ...
                    <img src="Leo.jfif" alt="Leo" class="image">
                </td>
                <td class="info-cell">
                    <h2>Descripción</h2>
                    <p class="intro-text">
                        Leo es un restaurante que se destaca por su innovación culinaria y enfoque en ingredientes frescos y locales. Ofrece una experiencia gastronómica única en un ambiente elegante y acogedor.
                    </p>
        ...
        <div class="comments-container">
            ...
            <div class="star-image">
                ...
                <form id="comentarioForm" onsubmit="submitComment(event, 'comentariosLeo')">
                    ...
                    <button type="button" onclick="clearComments('comentariosLeo')">Borrar Comentarios</button>
                </form>
            </div>
    ...
    <script>
       ...
       document.addEventListener("DOMContentLoaded", function() {
           displayComments('comentariosLeo');
       });
    </script>
</body>
</html>
