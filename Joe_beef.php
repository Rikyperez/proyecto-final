...
<body>
    ...
    <div class="container">
        ...
        <table class="reservation-table">
            <tr>
                <td class="image-cell">
                    ...
                    <img src="Joe_Beef.jfif" alt="Joe Beef" class="image">
                </td>
                <td class="info-cell">
                    <h2>Descripción</h2>
                    <p class="intro-text">
                        Joe Beef es un destino culinario famoso por su enfoque en ingredientes locales y técnicas de cocina innovadoras. Con un ambiente rústico y acogedor, es el lugar ideal para disfrutar de una experiencia gastronómica excepcional.
                    </p>
        ...
        <div class="comments-container">
            ...
            <div class="star-image">
                ...
                <form id="comentarioForm" onsubmit="submitComment(event, 'comentariosJoeBeef')">
                    ...
                    <button type="button" onclick="clearComments('comentariosJoeBeef')">Borrar Comentarios</button>
                </form>
            </div>
    ...
    <script>
       ...
       document.addEventListener("DOMContentLoaded", function() {
           displayComments('comentariosJoeBeef');
       });
    </script>
</body>
</html>
