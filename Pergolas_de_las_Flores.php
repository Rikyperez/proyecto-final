...
<head>
    ...
    <title>Pérgolas de las Flores</title>
...
<body>
    ...
    <div class="container">
        ...
        <table class="reservation-table">
            <tr>
                <td class="image-cell">
                    ...
                    <img src="Pergolas_de_las_Flores.jfif" alt="Pérgolas de las Flores" class="image">
                </td>
                <td class="info-cell">
                    <h2>Descripción</h2>
                    <p class="intro-text">
                        Pérgolas de las Flores es un encantador restaurante que ofrece una experiencia culinaria rodeada de naturaleza. Con una atmósfera acogedora y platos que destacan por su frescura, es el lugar perfecto para disfrutar de una comida memorable en un entorno sereno y florido.
                    </p>
        ...
        <div class="comments-container">
            ...
            <div class="star-image">
                ...
                <form id="comentarioForm" onsubmit="submitComment(event, 'comentariosPergolasDeLasFlores')">
                    ...
                    <button type="button" onclick="clearComments('comentariosPergolasDeLasFlores')">Borrar Comentarios</button>
                </form>
            </div>
    ...
    <script>
       ...
       document.addEventListener("DOMContentLoaded", function() {
           displayComments('comentariosPergolasDeLasFlores');
       });
    </script>
</body>
</html>
