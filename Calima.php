...
<body>
    ...
    <div class="container">
        ...
        <table class="reservation-table">
            <tr>
                <td class="image-cell">
                    ...
                    <img src="Calima.jfif" alt="Calima" class="image">
                </td>
                <td class="info-cell">
                    <h2>Descripción</h2>
                    <p class="intro-text">
                        Calima es un restaurante que celebra la cocina contemporánea, fusionando sabores tradicionales con técnicas modernas. Disfruta de un menú degustación que te llevará en un viaje culinario inolvidable.
                    </p>
        ...
        <div class="comments-container">
            ...
            <div class="star-image">
                ...
                <form id="comentarioForm" onsubmit="submitComment(event, 'comentariosCalima')">
                    ...
                    <button type="button" onclick="clearComments('comentariosCalima')">Borrar Comentarios</button>
                </form>
            </div>
    ...
    <script>
       ...
       document.addEventListener("DOMContentLoaded", function() {
           displayComments('comentariosCalima');
       });
    </script>
</body>
</html>
