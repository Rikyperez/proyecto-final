...
<body>
    ...
    <div class="container">
        ...
        <table class="reservation-table">
            <tr>
                <td class="image-cell">
                    ...
                    <img src="Harry_Sasson.jfif" alt="Harry Sasson" class="image">
                </td>
                <td class="info-cell">
                    <h2>Descripción</h2>
                    <p class="intro-text">
                        Harry Sasson es un restaurante emblemático que combina la cocina internacional con toques de la gastronomía local. Su ambiente sofisticado y su atención al detalle lo convierten en un destino perfecto para los amantes de la buena comida.
                    </p>
        ...
        <div class="comments-container">
            ...
            <div class="star-image">
                ...
                <form id="comentarioForm" onsubmit="submitComment(event, 'comentariosHarrySasson')">
                    ...
                    <button type="button" onclick="clearComments('comentariosHarrySasson')">Borrar Comentarios</button>
                </form>
            </div>
    ...
    <script>
       ...
       document.addEventListener("DOMContentLoaded", function() {
           displayComments('comentariosHarrySasson');
       });
    </script>
</body>
</html>
