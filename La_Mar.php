...
<body>
    ...
    <div class="container">
        ...
        <table class="reservation-table">
            <tr>
                <td class="image-cell">
                    ...
                    <img src="La_Mar.jfif" alt="La Mar" class="image">
                </td>
                <td class="info-cell">
                    <h2>Descripción</h2>
                    <p class="intro-text">
                        La Mar es un restaurante emblemático que celebra la rica tradición culinaria del mar. Ofrece una variedad de platos frescos y deliciosos, con un enfoque en la calidad de los ingredientes y la sostenibilidad, creando una experiencia gastronómica inolvidable.
                    </p>
        ...
        <div class="comments-container">
            ...
            <div class="star-image">
                ...
                <form id="comentarioForm" onsubmit="submitComment(event, 'comentariosLaMar')">
                    ...
                    <button type="button" onclick="clearComments('comentariosLaMar')">Borrar Comentarios</button>
                </form>
            </div>
    ...
    <script>
       ...
       document.addEventListener("DOMContentLoaded", function() {
           displayComments('comentariosLaMar');
       });
    </script>
</body>
</html>
