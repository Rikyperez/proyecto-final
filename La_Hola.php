...
<body>
    ...
    <div class="container">
        ...
        <table class="reservation-table">
            <tr>
                <td class="image-cell">
                    ...
                    <img src="La_Hola.jfif" alt="La Hola" class="image">
                </td>
                <td class="info-cell">
                    <h2>Descripción</h2>
                    <p class="intro-text">
                        La Hola es un restaurante moderno que ofrece una experiencia culinaria única, combinando sabores locales con técnicas internacionales. Su ambiente acogedor y su atención al detalle hacen de cada visita una experiencia memorable.
                    </p>
        ...
        <div class="comments-container">
            ...
            <div class="star-image">
                ...
                <form id="comentarioForm" onsubmit="submitComment(event, 'comentariosLaHola')">
                    ...
                    <button type="button" onclick="clearComments('comentariosLaHola')">Borrar Comentarios</button>
                </form>
            </div>
    ...
    <script>
       ...
       document.addEventListener("DOMContentLoaded", function() {
           displayComments('comentariosLaHola');
       });
    </script>
</body>
</html>
