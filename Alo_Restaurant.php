...
<body>
    ...
    <div class="container">
        ...
        <table class="reservation-table">
            <tr>
                <td class="image-cell">
                    ...
                    <img src="Alo_Restaurant.jfif" alt="Alo Restaurant" class="image">
                </td>
                <td class="info-cell">
                    <h2>Descripción</h2>
                    <p class="intro-text">
                        Alo Restaurant ofrece una experiencia gastronómica excepcional con un enfoque en ingredientes locales y de temporada. Ven a disfrutar de platos innovadores en un ambiente elegante y acogedor. ¡Una visita que no te puedes perder!
                    </p>
        ...
        <div class="comments-container">
            ...
            <div class="star-image">
                ...
                <form id="comentarioForm" onsubmit="submitComment(event, 'comentariosAloRestaurant')">
                    ...
                    <button type="button" onclick="clearComments('comentariosAloRestaurant')">Borrar Comentarios</button>
                </form>
            </div>
    ...
    <script>
       ...
       document.addEventListener("DOMContentLoaded", function() {
           displayComments('comentariosAloRestaurant');
       });
    </script>
</body>
</html>
