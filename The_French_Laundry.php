...
<body>
    ...
    <div class="container">
        ...
        <table class="reservation-table">
            <tr>
                <td class="image-cell">
                    ...
                    <img src="The_French_Laundry.jfif" alt="The French Laundry" class="image">
                </td>
                <td class="info-cell">
                    <h2>Descripción</h2>
                    <p class="intro-text">
                        The French Laundry es un famoso restaurante de alta cocina ubicado en Napa Valley, conocido por sus menús degustación innovadores y la excepcional atención al detalle en cada plato.
                    </p>
        ...
        <div class="comments-container">
            ...
            <div class="star-image">
                ...
                <form id="comentarioForm" onsubmit="submitComment(event, 'comentariosFrenchLaundry')">
                    ...
                    <button type="button" onclick="clearComments('comentariosFrenchLaundry')">Borrar Comentarios</button>
                </form>
            </div>
    ...
    <script>
       ...
       document.addEventListener("DOMContentLoaded", function() {
           displayComments('comentariosFrenchLaundry');
       });
    </script>
</body>
</html>
