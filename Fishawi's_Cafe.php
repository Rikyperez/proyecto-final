...
<body>
    ...
    <div class="container">
        ...
        <table class="reservation-table">
            <tr>
                <td class="image-cell">
                    ...
                    <img src="Fishawi's_Cafe.jfif" alt="Fishawi's Cafe" class="image">
                </td>
                <td class="info-cell">
                    <h2>Descripción</h2>
                    <p class="intro-text">
                        Fishawi's Cafe es famoso por su auténtico té egipcio y una variedad de deliciosos platillos locales. Un lugar perfecto para disfrutar de un ambiente acogedor y una experiencia culinaria única.
                    </p>
        ...
        <div class="comments-container">
            ...
            <div class="star-image">
                ...
                <form id="comentarioForm" onsubmit="submitComment(event, 'comentariosFishawisCafe')">
                    ...
                    <button type="button" onclick="clearComments('comentariosFishawisCafe')">Borrar Comentarios</button>
                </form>
            </div>
    ...
    <script>
       ...
       document.addEventListener("DOMContentLoaded", function() {
           displayComments('comentariosFishawisCafe');
       });
    </script>
</body>
</html>
