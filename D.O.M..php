...
<body>
    ...
    <div class="container">
        ...
        <table class="reservation-table">
            <tr>
                <td class="image-cell">
                    ...
                    <img src="D.O.M..jfif" alt="D.O.M" class="image">
                </td>
                <td class="info-cell">
                    <h2>Descripción</h2>
                    <p class="intro-text">
                        D.O.M es un restaurante que destaca por su fusión de sabores brasileños y técnicas culinarias modernas, creando un ambiente único para disfrutar de una experiencia gastronómica inolvidable.
                    </p>
        ...
        <div class="comments-container">
            ...
            <div class="star-image">
                ...
                <form id="comentarioForm" onsubmit="submitComment(event, 'comentariosDOM')">
                    ...
                    <button type="button" onclick="clearComments('comentariosDOM')">Borrar Comentarios</button>
                </form>
            </div>
    ...
    <script>
       ...
       document.addEventListener("DOMContentLoaded", function() {
           displayComments('comentariosDOM');
       });
    </script>
</body>
</html>
