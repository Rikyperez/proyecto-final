...
<body>
    ...
    <div class="container">
        ...
        <table class="reservation-table">
            <tr>
                <td class="image-cell">
                    ...
                    <img src="El_Cielo.jfif" alt="El Cielo" class="image">
                </td>
                <td class="info-cell">
                    <h2>Descripción</h2>
                    <p class="intro-text">
                        El Cielo es un restaurante que ofrece una experiencia culinaria inigualable, donde cada plato está diseñado para deleitar los sentidos con sabores innovadores y presentación artística.
                    </p>
        ...
        <div class="comments-container">
            ...
            <div class="star-image">
                ...
                <form id="comentarioForm" onsubmit="submitComment(event, 'comentariosElCielo')">
                    ...
                    <button type="button" onclick="clearComments('comentariosElCielo')">Borrar Comentarios</button>
                </form>
            </div>
    ...
    <script>
       ...
       document.addEventListener("DOMContentLoaded", function() {
           displayComments('comentariosElCielo');
       });
    </script>
</body>
</html>
