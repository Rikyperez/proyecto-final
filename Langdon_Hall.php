...
<body>
    ...
    <div class="container">
        ...
        <table class="reservation-table">
            <tr>
                <td class="image-cell">
                    ...
                    <img src="Langdon_Hall.jfif" alt="Langdon Hall" class="image">
                </td>
                <td class="info-cell">
                    <h2>Descripción</h2>
                    <p class="intro-text">
                        Langdon Hall es un restaurante de lujo que ofrece una experiencia gastronómica excepcional, combinando técnicas culinarias tradicionales con ingredientes de temporada frescos. Su entorno elegante lo convierte en un destino ideal para ocasiones especiales.
                    </p>
        ...
        <div class="comments-container">
            ...
            <div class="star-image">
                ...
                <form id="comentarioForm" onsubmit="submitComment(event, 'comentariosLangdon')">
                    ...
                    <button type="button" onclick="clearComments('comentariosLangdon')">Borrar Comentarios</button>
                </form>
            </div>
    ...
    <script>
       ...
       document.addEventListener("DOMContentLoaded", function() {
           displayComments('comentariosLangdon');
       });
    </script>
</body>
</html>
