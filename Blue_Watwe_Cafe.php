...
<body>
    ...
    <div class="container">
        ...
        <table class="reservation-table">
            <tr>
                <td class="image-cell">
                    ...
                    <img src="Blue_Water_Cafe.jfif" alt="Blue Water Cafe" class="image">
                </td>
                <td class="info-cell">
                    <h2>Descripción</h2>
                    <p class="intro-text">
                        Blue Water Cafe es el lugar perfecto para disfrutar de mariscos frescos en un ambiente relajante. Con vistas al océano, ofrece una experiencia gastronómica inolvidable que combina sabores locales con toques innovadores.
                    </p>
        ...
        <div class="comments-container">
            ...
            <div class="star-image">
                ...
                <form id="comentarioForm" onsubmit="submitComment(event, 'comentariosBlueWaterCafe')">
                    ...
                    <button type="button" onclick="clearComments('comentariosBlueWaterCafe')">Borrar Comentarios</button>
                </form>
            </div>
    ...
    <script>
       ...
       document.addEventListener("DOMContentLoaded", function() {
           displayComments('comentariosBlueWaterCafe');
       });
    </script>
</body>
</html>
