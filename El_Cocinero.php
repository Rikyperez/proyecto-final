...
<body>
    ...
    <div class="container">
        ...
        <table class="reservation-table">
            <tr>
                <td class="image-cell">
                    ...
                    <img src="El_Cocinero.jfif" alt="El Cacinero" class="image">
                </td>
                <td class="info-cell">
                    <h2>Descripción</h2>
                    <p class="intro-text">
                        El Cacinero es un lugar donde la gastronomía se eleva a una nueva dimensión, ofreciendo platos innovadores que celebran los sabores auténticos de la cocina.
                    </p>
        ...
        <div class="comments-container">
            ...
            <div class="star-image">
                ...
                <form id="comentarioForm" onsubmit="submitComment(event, 'comentariosElCacinero')">
                    ...
                    <button type="button" onclick="clearComments('comentariosElCacinero')">Borrar Comentarios</button>
                </form>
            </div>
    ...
    <script>
       ...
       document.addEventListener("DOMContentLoaded", function() {
           displayComments('comentariosElCacinero');
       });
    </script>
</body>
</html>
