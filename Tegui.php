...
<body>
    ...
    <div class="container">
        ...
        <table class="reservation-table">
            <tr>
                <td class="image-cell">
                    ...
                    <img src="Tegui.jfif" alt="Tegui" class="image">
                </td>
                <td class="info-cell">
                    <h2>Descripción</h2>
                    <p class="intro-text">
                        Tegui es un prestigioso restaurante argentino que ofrece una experiencia culinaria única, combinando ingredientes locales con técnicas innovadoras, en un ambiente elegante y contemporáneo.
                    </p>
        ...
        <div class="comments-container">
            ...
            <div class="star-image">
                ...
                <form id="comentarioForm" onsubmit="submitComment(event, 'comentariosTegui')">
                    ...
                    <button type="button" onclick="clearComments('comentariosTegui')">Borrar Comentarios</button>
                </form>
            </div>
    ...
    <script>
       ...
       document.addEventListener("DOMContentLoaded", function() {
           displayComments('comentariosTegui');
       });
    </script>
</body>
</html>
